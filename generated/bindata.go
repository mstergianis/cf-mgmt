...
func filesCfMgmtSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "files/cf-mgmt.sh", size: 83, mode: os.FileMode(493), modTime: time.Unix(1582554995, 0)}
...
func filesCfMgmtYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "files/cf-mgmt.yml", size: 357, mode: os.FileMode(420), modTime: time.Unix(1582554995, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func filesPipelineYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "files/pipeline.yml", size: 9312, mode: os.FileMode(420), modTime: time.Unix(1582554995, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func filesVarsTemplateYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "files/vars-template.yml", size: 798, mode: os.FileMode(420), modTime: time.Unix(1582554995, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
